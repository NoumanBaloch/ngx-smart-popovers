# ngx-smart-popover
Simple popover control for your angular (v4+) applications using bootstrap4 with smart reflection logic when overflowing the viewport. This is a continuation of ngx-popover (https://github.com/pleerock/ngx-popover). If you don't want to use it without bootstrap - simply create proper css classes.

See a quick [DEMO](https://ngx-smart-popover-demo.stackblitz.io)
